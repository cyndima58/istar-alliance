...
.login-logo{font-size:38px;margin-bottom:8px;text-align:center;}
.login-brand{font-family:var(--font-display);font-size:22px;font-weight:700;color:var(--gold);letter-spacing:.04em;text-align:center;margin-bottom:4px;}
.login-sub{font-size:13px;color:var(--star-3);text-align:center;margin-bottom:32px;}
.login-card{width:100%;background:var(--space-2);border:1px solid rgba(255,255,255,.08);border-radius:var(--r-lg);padding:24px 20px;}
...
.login-divider-text{font-size:12px;color:var(--star-3);}
.login-error{background:rgba(224,92,92,.12);border:1px solid rgba(224,92,92,.3);border-radius:var(--r);padding:10px 14px;font-size:13px;color:var(--coral);margin-bottom:12px;text-align:center;}
.login-no-access{background:rgba(201,168,76,.08);border:1px solid rgba(201,168,76,.2);border-radius:var(--r);padding:12px 14px;font-size:13px;color:var(--gold);text-align:center;margin-top:12px;line-height:1.6;}
.logout-btn{padding:6px 12px;border-radius:var(--r);border:1px solid rgba(255,255,255,.12);background:transparent;color:var(--star-3);font-size:11px;font-family:var(--font-body);cursor:pointer;transition:all .2s;}
...
════════════════════════════════════════ */
const GROWTH_STAGES = [
  { num:"01", name:"探索",    tag:"入星",      sub:"定位體驗班 · 4小時",              status:"done",   dotColor:"#C9A84C", dotGlow:"rgba(201,168,76,.35)", tasks:"感受星辰聯盟氛圍，初步盤點個人能力",               output:"個人能力初步地圖（教練協助繪製）",              unlock:"完成體驗並決定進入個人賦能班",                course:"定位體驗班 · 4小時" },
  ...
  { num:"04", name:"定位",    tag:"定位",      sub:"個人賦能班 Week 3–6",            status:"active", dotColor:"#C9A84C", dotGlow:"rgba(201,168,76,.4)",  tasks:"品牌定位 · 差異化分析 · 目標受眾輪廓 · 核心訊息", output:"個人品牌一頁紙（定位宣言）",                   unlock:"定位一頁紙通過教練審核，並向同儕小組分享",      course:"個人賦能班 Week 3–6", pct:68 },
  { num:"05", name:"方向",    tag:"方向",      sub:"個人賦能班 Week 7–12",           status:"future", opacity:0.55, dotColor:"#6C5CE7", tasks:"商業模式設計 · 收入路徑規劃 · 90天里程碑",       output:"個人商業模式一頁紙 + 第一個 90 天計畫",          unlock:"完成 12 週，有具體行動計畫",                  course:"個人賦能班 Week 7–12" },
  { num:"06", name:"小驗",    tag:"驗證",      sub:"低風險市場驗證 · 彈性時間",         status:"future", opacity:0.40, dotColor:"#00B89C", tasks:"設計最小可行驗證行動，執行並觀察市場反應",             output:"驗證報告：什麼最有共鳴、哪裡需要調整",           unlock:"完成至少一次真實的市場驗證並整理回饋",           course:"演講 / 文章 / 諮詢 / 免費工作坊（擇一）" },
  { num:"07", name:"實作",    tag:"實作",      sub:"創業預備班 Phase 1–2",           status:"future", opacity:0.30, dotColor:"#E05C5C", tasks:"系統化產品 / 服務設計，建立穩定的交付流程",           output:"可重複銷售的產品原型 + 第一張訂單",              unlock:"完成第一筆付費成交",                          course:"創業預備班 Phase 1–2" },
  { num:"08", name:"市場",    tag:"市場",      sub:"創業預備班 Phase 3–4",           status:"future", opacity:0.20, dotColor:"#E05C5C", tasks:"流量策略 · 客戶旅程設計 · 銷售系統建立",             output:"穩定的月收入來源 + 可複製的獲客流程",            unlock:"達到可持續的月收入目標",                       course:"創業預備班 Phase 3–4" },
  { num:"09", name:"共創",    tag:"✦ 星辰成員", sub:"創業預備班 Phase 5–6 → 聯盟成員", status:"future", opacity:0.15, dotColor:"#C9A84C", dotGlow:"rgba(201,168,76,.5)", tasks:"事業系統化 · 與聯盟夥伴協作 · 股權共創結構", output:"成立公司 + 與 iSTAR Alliance 完成股權綁定", unlock:"完成股權綁定，正式成為 iSTAR Alliance 成員", course:"創業預備班 Phase 5–6 + 聯盟導師陪跑" },
];
...
// ── SVG Icons ──
const IcHome  = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>;
const IcGrid  = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>;
const IcPath  = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>;
const IcMsg   = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>;
const IcLayer = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5M2 12l10 5 10-5"/></svg>;
const IcSwap  = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><polyline points="8 6 2 12 8 18"/><polyline points="16 6 22 12 16 18"/></svg>;
const IcDoc   = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>;
...
function ChipGroup({ options, defaultSel = [] }) {
  ...
  const toggle = (o) =>
    setSel((prev) => { const n = new Set(prev); n.has(o) ? n.delete(o) : n.add(o); return n; });
  return (
    <div className="chip-group">
      {options.map((o) => (
        <div key={o} className={"chip" + (sel.has(o) ? " sel" : "")} onClick={() => toggle(o)}>{o}</div>
      ))}
    </div>
  );
}
...
function GrowthItem({ s }) {
  ...
  const cardExtraStyle = s.status === "active"
    ? { borderColor: open ? "rgba(201,168,76,.6)" : "rgba(201,168,76,.35)", background: "rgba(201,168,76,.04)" }
    : s.status === "done"
  ...
  return (
    <div className="journey-item" style={s.opacity != null ? { opacity: s.opacity } : {}}>
      <div className="journey-dot" style={dotStyle}>
        {s.status === "done"   && <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round"><polyline points="20 6 9 17 4 12"/></svg>}
        {s.status === "active" && <div style={{ width:7, height:7, borderRadius:"50%", background: s.dotColor }} />}
        {s.status === "future" && <span style={{ fontSize:9, color:"var(--star-3)", fontWeight:700 }}>{s.num}</span>}
      </div>

      <div
        className={"card" + (s.status === "done" ? " card-sm" : "")}
        style={{ ...cardExtraStyle, cursor: s.status !== "future" ? "pointer" : "default" }}
        ...
        {s.status === "done" && (
          <>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:6 }}>
              <div>
                <div style={{ fontSize:10, fontWeight:700, letterSpacing:".08em", color:"var(--teal)", marginBottom:3 }}>{s.tag.toUpperCase()}</div>
            ...
            {open && (
              <div style={{ paddingTop:10, borderTop:"1px solid rgba(255,255,255,.06)", marginTop:4 }}>
        ...
        {s.status === "active" && (
          <>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:8 }}>
              <div>
                <div style={{ fontSize:10, fontWeight:700, letterSpacing:".08em", color:"var(--gold)", marginBottom:3 }}>{s.tag.toUpperCase()} · 當前階段 ▶</div>
            ...
            {open && (
              <div style={{ paddingTop:10, borderTop:"1px solid rgba(201,168,76,.2)", marginTop:4 }}>
                <div className="detail-meta-row"><span className="detail-meta-lbl">核心任務</span><span className="detail-meta-val">{s.tasks}</span></div>
                <div className="detail-meta-row"><span className="detail-meta-lbl">關鍵產出</span><span className="detail-meta-val">{s.output}</span></div>
        ...
        {s.status === "future" && (
          <>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              <div>
                <div style={{ fontSize:10, fontWeight:700, letterSpacing:".08em", color: isCoCreate ? "rgba(201,168,76,.5)" : "var(--star-3)", marginBottom:3 }}>
                  {s.tag.toUpperCase()}
                </div>
                <div className="j-title" style={isCoCreate ? { color:"rgba(201,168,76,.5)" } : {}}>{s.num}. {s.name}</div>
                <div className="j-sub">{s.sub}</div>
              </div>
              <IcLock />
            </div>
            {isCoCreate && (
              <div style={{ marginTop:10, padding:"8px 10px", background:"rgba(201,168,76,.06)", borderRadius:8, border:"1px solid rgba(201,168,76,.15)", fontSize:11, color:"rgba(201,168,76,.5)" }}>
  ...
  return (
    <div className="modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal-sheet">
        ...
        <select className="input-field">
          <option>林○○</option><option>張○○</option><option>陳○○</option>
        </select>
...
function SHome({ onSwitch }) {
  return (
    <div className="screen-enter" style={{ display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
      <div className="topbar">
        <div>
          <div className="istar-logo"><span className="istar-mark">✦</span> iSTAR</div>
          <div style={{ fontSize:11, color:"var(--star-3)", marginTop:1 }}>星辰聯盟</div>
        </div>
        <div className="avatar">林O</div>
      </div>
      <div className="content">
        <div className="card-gold" style={{ marginBottom:12 }}>
          <div className="greeting-name">早安，林同學 <span style={{ fontSize:18 }}>✦</span></div>
          <div className="greeting-sub" style={{ marginTop:4 }}>你正在「定位」階段的路上，保持前進</div>
          <div style={{ marginTop:12 }}>
            <div className="stage-bar">
              {STAGE_SEGS.map((s, i) => <div key={i} className={`stage-seg ${s}`} />)}
            </div>
            <div style={{ fontSize:11, color:"var(--gold)" }}>第 4 / 9 階段 · 定位</div>
          </div>
        </div>
        <div className="stats-grid">
          <div className="stat-tile"><div className="stat-num gold">8</div><div className="stat-lbl">已完成課程</div></div>
          <div className="stat-tile"><div className="stat-num nebula">68%</div><div className="stat-lbl">當前路徑進度</div></div>
        </div>
        <div className="sec-h">本週課程</div>
        <div className="card-glow">
          <div className="course-header">
            <div>
              <span className="badge badge-nebula" style={{ marginBottom:7 }}>🌱 個人賦能班</span>
          ...
          <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:5 }}>
            <span style={{ fontSize:11, color:"var(--star-3)" }}>預習進度</span>
        ...
        <div className="card card-sm" style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
          <div>
            ...
            <div style={{ fontSize:11, color:"var(--star-3)" }}>週六 14:00 · 實體</div>
          </div>
        ...
        <div className="card">
          ...
          <div className="feedback-quote">你的定位草稿很清晰，下週試著加入「對象痛點」的描述，會更有說服力。</div>
        </div>
  ...
  return (
    <div className="screen-enter" style={{ display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
      ...
      <div className="inner-tabs" style={{ padding:"0 16px" }}>
        {[["all","全部"],["ongoing","進行中"],["done","已完成"]].map(([key,label]) => (
          <button
            key={key}
      ...
      <div className="content" style={{ paddingTop:8 }}>
        ...
        <div className="card-glow">
          <div className="course-header">
            ...
            <span style={{ fontSize:11, color:"var(--star-3)" }}>第 3 週 / 共 12 週</span>
          </div>
          <div className="course-name" style={{ marginTop:8 }}>🌱 個人賦能班</div>
          <div className="course-meta" style={{ marginBottom:10 }}>主教練：王志遠 · 個人品牌 × 收入轉化</div>
          <div className="prog-track" style={{ marginBottom:5 }}><div className="prog-fill" style={{ width:"25%" }} /></div>
          <div style={{ fontSize:11, color:"var(--star-3)", marginBottom:12 }}>25% 完成</div>
          <div className="btn-row" style={{ marginTop:0 }}>
            <button className="btn" style={{ fontSize:12 }}>查看課程模組</button>
            <button className="btn btn-primary" style={{ fontSize:12 }}>聯絡教練</button>
          </div>
        </div>
        )}
        ...
        <div className="card">
          <div className="course-header">
            ...
            <span style={{ fontSize:11, color:"var(--star-3)" }}>2025.01</span>
          </div>
          <div className="course-name" style={{ marginTop:8 }}>🔍 定位體驗班</div>
          <div className="course-meta" style={{ marginBottom:10 }}>主教練：陳美珍 · 4 小時沉浸體驗</div>
          <div className="prog-track"><div className="prog-fill" style={{ width:"100%" }} /></div>
          <div style={{ fontSize:11, color:"var(--teal)", marginTop:5 }}>✓ 已完成</div>
        </div>
        )}
      </div>
    ...
    <div className="screen-enter" style={{ display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
      ...
      <div className="content">
        <div className="card-gold" style={{ marginBottom:14 }}>
          <div style={{ fontSize:10, color:"var(--gold)", letterSpacing:".1em", fontWeight:700, marginBottom:6 }}>✦ 目前所在階段</div>
          <div style={{ fontSize:24, fontWeight:800, fontFamily:"var(--font-display)", letterSpacing:"-.02em" }}>定位</div>
          <div style={{ fontSize:12, color:"rgba(201,168,76,.75)", marginTop:3 }}>找到屬於你的位置，讓能力被市場看見</div>
          <div style={{ marginTop:14 }}>
            <div className="stage-bar">
              {STAGE_SEGS.map((s, i) => <div key={i} className={`stage-seg ${s}`} />)}
            </div>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginTop:6 }}>
              <span style={{ fontSize:11, color:"var(--gold)" }}>第 4 / 9 階段</span>
              <span style={{ fontSize:11, color:"var(--star-3)" }}>預計還需 8 週</span>
            </div>
          </div>
        </div>
        {/* 圖例 */}
        <div style={{ display:"flex", gap:12, padding:"8px 12px", background:"var(--space-3)", borderRadius:"var(--r)", marginBottom:14, flexWrap:"wrap" }}>
          {[["#C9A84C","入星"],["#6C5CE7","賦能"],["#00B89C","驗證"],["#E05C5C","創業"]].map(([c,l]) => (
  ...
  return (
    <div className="screen-enter" style={{ display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
      ...
      <div className="content">
        ...
        <div className="card">
          {[
            { av:"王志", bg:"linear-gradient(135deg,#6C5CE7,#9B8BF4)", name:"王志遠", badge:true,  tag:"個人品牌 · 商業模式" },
            { av:"陳美", bg:"linear-gradient(135deg,#00B89C,#00D4B8)", name:"陳美珍", badge:false, tag:"自我認知 · 職涯定向", last:true },
          ].map((c) => (
            <div key={c.name} className="coach-row" style={c.last ? { borderBottom:"none" } : {}}>
              <div className="coach-av" style={{ background:c.bg }}>{c.av}</div>
              <div style={{ flex:1 }}>
                <div className="coach-name">
                  {c.name}{c.badge && <span className="badge badge-gold" style={{ fontSize:10, marginLeft:4 }}>主教練</span>}
                </div>
                <div className="coach-tag">{c.tag}</div>
              </div>
              <button className="btn" style={{ fontSize:12, padding:"7px 10px" }}>聯絡</button>
            </div>
          ))}
        </div>
        ...
        <div className="card">
          ...
          <div className="feedback-quote">這週的品牌定位工作坊你表現積極，對「差異化」的思考更清晰了，下週試著加入目標受眾的輪廓描述。</div>
          <div style={{ display:"flex", gap:6, alignItems:"center" }}>
            <span style={{ fontSize:11, color:"var(--star-3)" }}>情緒狀態</span>
...
function CHome({ onSwitch }) {
  const students = [
    { av:"林O", bg:"linear-gradient(135deg,#6C5CE7,#9B8BF4)", name:"林○○", badge:true,  sub:"個人賦能班 · 定位 68%" },
    { av:"張O", bg:"linear-gradient(135deg,#BA7517,#EF9F27)", name:"張○○", badge:false, sub:"創業預備班 · 方向 40%" },
    { av:"陳O", bg:"linear-gradient(135deg,#00B89C,#00D4B8)", name:"陳○○", badge:false, sub:"個人賦能班 · 自我認知 90%", last:true },
  ];
  return (
    <div className="screen-enter" style={{ display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
      <div className="topbar">
        <div>
          ...
          <div style={{ fontSize:11, color:"var(--star-3)", marginTop:1 }}>Coach Dashboard</div>
        </div>
        <div className="avatar" style={{ background:"linear-gradient(135deg,#00B89C,#00D4B8)" }}>王志</div>
      </div>
      <div className="content">
        <div className="card" style={{ borderColor:"rgba(0,184,156,.2)", marginBottom:12 }}>
          <div style={{ fontSize:18, fontWeight:700, fontFamily:"var(--font-display)" }}>王志遠教練</div>
          <div style={{ fontSize:13, color:"var(--star-2)", marginTop:3 }}>本週 2 堂課 · 負責 4 位學員</div>
        </div>
        <div className="stats-grid">
          <div className="stat-tile"><div className="stat-num" style={{ color:"var(--teal)" }}>4</div><div className="stat-lbl">負責學員</div></div>
          <div className="stat-tile"><div className="stat-num" style={{ color:"var(--nebula)" }}>12</div><div className="stat-lbl">課程模組</div></div>
        </div>
        <div className="sec-h">我的學員</div>
        <div className="card" style={{ padding:"8px 14px" }}>
          {students.map((r) => (
            <div key={r.name} className="coach-row" style={r.last ? { borderBottom:"none" } : {}}>
              <div className="coach-av" style={{ background:r.bg, fontSize:12 }}>{r.av}</div>
              <div style={{ flex:1 }}>
                <div className="coach-name" style={{ fontSize:13 }}>
                  {r.name}{r.badge && <span className="badge badge-gold" style={{ fontSize:10, marginLeft:4 }}>主教練</span>}
                </div>
                <div className="coach-tag">{r.sub}</div>
              </div>
              <button className="btn" style={{ fontSize:11, padding:"6px 10px" }} onClick={() => onSwitch("assign")}>分配</button>
            </div>
          ))}
        </div>
        ...
        <div className="qa-grid">
          ...
          <button className="qa-card"><span className="qa-icon">🗺</span><div className="qa-label">成長路徑</div><div className="qa-sub">後台設定</div></button>
        </div>
      </div>
...
function CModules({ onSwitch, onModal }) {
  const mods = [
    { cls:"",       tags:[{cls:"badge-nebula",t:"定位"},{t:"3小時"},{t:"線上"}],  title:"個人品牌定位工作坊", outline:"品牌定義 → 差異化分析 → 核心訊息萃取" },
    { cls:"teal-l", tags:[{cls:"badge-teal",  t:"市場"},{t:"2小時"},{t:"實體"}],  title:"市場驗證策略",       outline:"MVP設計 → 用戶訪談 → 數據解讀" },
    { cls:"gold-l", tags:[{cls:"badge-gold",  t:"自我認知"},{t:"4小時"},{t:"實體"}], title:"MBTI 優勢盤點",  outline:"測評解析 → 優勢地圖 → 行動計畫" },
  ];
  const dimTag = { background:"rgba(255,255,255,.05)", color:"var(--star-3)", border:"1px solid rgba(255,255,255,.08)" };
  return (
    <div className="screen-enter" style={{ display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
      <div className="topbar">
        <div className="topbar-title">課程模組</div>
        <button className="btn btn-primary" style={{ fontSize:12, padding:"7px 14px" }} onClick={() => onModal("module")}>+ 新增</button>
      </div>
      <div className="content">
        {mods.map((m) => (
          <div key={m.title} className={`mod-card ${m.cls}`}>
            <div className="mod-tags">
              {m.tags.map((tg) => (
                <span key={tg.t} className={"badge " + (tg.cls || "")} style={tg.cls ? {} : dimTag}>{tg.t}</span>
              ))}
            </div>
        ...
        <button className="btn" style={{ width:"100%", marginTop:4 }} onClick={() => onModal("module")}>+ 新增課程模組</button>
      </div>
...
function CAssign({ onSwitch }) {
  const pool = ["品牌定位工作坊","市場驗證策略","MBTI優勢盤點","商業模式設計","第一筆收入策略"];
  ...
  return (
    <div className="screen-enter" style={{ display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
      ...
      <div className="content">
        <div style={{ fontSize:13, color:"var(--star-3)", marginBottom:12 }}>點擊下方模組，加入學員的專屬課程清單</div>
        <div className="sec-h">可用模組庫</div>
        <div className="module-pool">
          {pool.map((p) => (
            <span key={p} className="m-chip" onClick={() => addToStudent(p)}>✦ {p}</span>
          ))}
        </div>
        ...
        <div className="drop-zone">
          ...
          <div style={{ display:"flex", flexWrap:"wrap", gap:6 }}>
            {assigned.map((a) => (
              <span key={a} className="m-chip assigned">✓ {a}</span>
            ))}
          </div>
        </div>
  ...
  return (
    <div className="screen-enter" style={{ display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
      <div className="topbar">
        ...
        <button className="btn btn-primary" style={{ fontSize:12, padding:"7px 14px" }} onClick={() => onModal("record")}>+ 新增</button>
      </div>
      <div className="content">
        <div className="card" style={{ marginBottom:8 }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:10 }}>
            <div>
              <div style={{ fontSize:14, fontWeight:600 }}>品牌定位工作坊</div>
              <div style={{ fontSize:12, color:"var(--star-3)" }}>2025.06.12 · 林○○</div>
            </div>
          ...
          <div className="record-note">
            <div className="record-note-label" style={{ color:"var(--teal)" }}>給學員的回饋</div>
            本週表現積極，品牌訊息抓得很準，下週可試著延伸到目標客群描述。
          </div>
          <div className="record-note coach-only" style={{ marginTop:6 }}>
            <div className="record-note-label" style={{ color:"var(--nebula)" }}>教練私密備註</div>
        ...
        <div className="card card-sm" style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          <div>
            ...
            <div style={{ fontSize:11, color:"var(--star-3)" }}>2025.05.28 · 林○○</div>
          </div>
          <span className="badge badge-teal">學員可見</span>
        </div>
      </div>
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
      <div className="login-wrap">
        ...
        <div className="login-brand">iSTAR Alliance</div>
...
function NoAccessScreen({ user, logout }) {
  return (
    <div style={{ display:"flex", flexDirection:"column", flex:1, alignItems:"center", justifyContent:"center", padding:32 }}>
      ...
      <div style={{ fontSize:16, fontWeight:600, color:"var(--gold)", marginBottom:8 }}>尚未取得存取權限</div>
      <div style={{ fontSize:13, color:"var(--star-3)", textAlign:"center", lineHeight:1.7, marginBottom:24 }}>
        帳號（{user?.email}）<br />
        尚未被加入星辰聯盟系統。<br />
        請聯絡管理員開通您的權限。
      </div>
...
function CMembers({ onSwitch }) {
  ...
  const handleAdd = async (e) => {
    ...
    if (!form.name || !form.email || !form.password) {
      setResult({ ok:false, msg:"姓名、Email、密碼為必填。" });
      return;
    }
    setLoading(true);
    setResult(null);
    ...
    if (res.success) {
      ...
      setForm(f => ({ ...f, name:"", email:"", password:"", birthdate:"" }));
    } else {
  ...
  const roleColor = (r) => r === "coach" ? "var(--teal)" : "#A89CF4";
  const roleBg    = (r) => r === "coach" ? "var(--teal-dim)" : "var(--nebula-dim)";
  const roleBorder= (r) => r === "coach" ? "rgba(0,184,156,.3)" : "rgba(108,92,231,.3)";
  ...
  return (
    <div className="screen-enter" style={{ display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
      <div className="topbar">
        ...
        <button
          className={tab === "add" ? "btn btn-primary" : "btn"}
      ...
      {tab === "list" ? (
        <div className="content">
          ...
          {members.length === 0 && (
            <div style={{ textAlign:"center", color:"var(--star-3)", fontSize:13, marginTop:32 }}>
              還沒有成員，點右上角新增
            </div>
          )}
          {members.map(m => (
            <div key={m.uid} className="card card-sm" style={{ marginBottom:8 }}>
              <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                <div className="coach-av" style={{
                  background:`linear-gradient(135deg,${m.role==="coach"?"#00B89C,#00D4B8":"#6C5CE7,#9B8BF4"})`,
                ...
                <div style={{ flex:1, minWidth:0 }}>
                  <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:2 }}>
                    ...
                    <span style={{
                      ...
                      border:`1px solid ${roleBorder(m.role)}`,
                    }}>{roleLabel(m.role)}</span>
                  </div>
                  <div style={{ fontSize:11, color:"var(--star-3)" }}>{m.email}</div>
                  {m.courseType && (
                    <div style={{ fontSize:11, color:"var(--star-3)", marginTop:2 }}>
                      {m.courseType} · {m.joinDate || ""}
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className="content">
          {result && (
            <div style={{
              padding:"10px 14px", borderRadius:"var(--r)", marginBottom:12, fontSize:13, textAlign:"center",
              background: result.ok ? "var(--teal-dim)" : "rgba(224,92,92,.12)",
              border: `1px solid ${result.ok ? "rgba(0,184,156,.3)" : "rgba(224,92,92,.3)"}`,
              color: result.ok ? "var(--teal)" : "var(--coral)",
            }}>{result.msg}</div>
          )}
          <form onSubmit={handleAdd}>
            ...
            <div className="chip-group" style={{ marginBottom:12 }}>
              {["student","coach"].map(r => (
                <div
                  key={r}
                  className={"chip" + (form.role===r?" sel":"")}
            ...
            <div className="input-label">Email *</div>
            <input className="input-field" type="email" placeholder="student@email.com"
              value={form.email} onChange={e => setField("email", e.target.value)} />

            <div className="input-label">初始密碼 *（至少 6 碼）</div>
            <input className="input-field" type="text" placeholder="設定一組初始密碼"
            ...
            <div className="input-label">負責教練姓名</div>
            <input className="input-field" placeholder="教練姓名" value={form.coachName}
    ...
    return (
      <>
        ...
        <div className="app" style={{ alignItems:"center", justifyContent:"center" }}>
          ...
          <div style={{ fontSize:13, color:"var(--star-3)" }}>載入中…</div>
        </div>
      </>
    );
  }
    ...
    <>
      ...
      <div className="app">
        ...
        <div style={{
          ...
          <span style={{ fontSize:12, color:"var(--star-2)" }}>
            {role === "coach" ? "🎓 教練端" : "✦ 學員端"} · {displayName}
          </span>
          <span style={{
            fontSize:10, fontWeight:700, padding:"2px 8px",
            borderRadius:"var(--r-pill)",
            background: role === "coach" ? "var(--teal-dim)" : "var(--nebula-dim)",
            color:      role === "coach" ? "var(--teal)" : "#A89CF4",
            border: `1px solid ${role === "coach" ? "rgba(0,184,156,.3)" : "rgba(108,92,231,.3)"}`,
          }}>
