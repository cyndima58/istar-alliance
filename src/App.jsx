...
.btn-google{width:100%;padding:11px 16px;border-radius:var(--r);border:1px solid rgba(255,255,255,.15);background:var(--space-3);color:var(--star);font-size:14px;font-weight:500;font-family:var(--font-body);cursor:pointer;display:flex;align-items:center;justify-content:center;gap:10px;transition:border-color .2s;margin-bottom:4px;}
.btn-google:hover{border-color:rgba(201,168,76,.4);}
      ...
      <div className="login-wrap">
        ...
        <div className="login-card">
          ...
          {!showEmail ? (
            <button
              className="btn"
              style={{ width:"100%", justifyContent:"center", color:"var(--star-2)" }}
